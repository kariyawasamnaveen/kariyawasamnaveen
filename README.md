...
### Full-Stack AI & Mobile Solutions Engineer | Flutter • FastAPI • Python • WebRTC

Available for remote contractor roles, startup engineering sprints, and technical advisory.
...
- **AI & Intelligent Systems:** LangChain, OpenAI / Google Gemini APIs, Autonomous Agents, Vector Search, Local LLM Integration
- **Data & Cloud Infrastructure:** PostgreSQL, SQLite, Redis, Docker, Git/GitHub Actions
